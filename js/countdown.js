$(function () {
  ...
  $('#clock-c').countdown(get15dayFromNow(), function(event) {
    var $this = $(this).html(event.strftime(''
      ...
      + '<span class="h1 text-center fancy-font-title d-xs-block d-sm-none" style="color: #fefefa">%D</span><span class="h1 fancy-font-title d-xs-block d-sm-none" style="color: #fefefa"> Day%!d Left</span>'
